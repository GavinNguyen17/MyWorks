...
public class Driver {
    ...
    public static void testRun() {
        ...
        if (testMinStuCost) {
            ...
            System.out.println("Minimum student cost between Student "+i+" and Student "+j+": " + testProgram2.findMinimumStudentCost(students.get(i), students.get(j)));
                }        
        }
        }
